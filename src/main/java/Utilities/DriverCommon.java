...
public class DriverCommon extends BaseDriver {
    ...
    public static String getCurrentUrl(){
        return BaseDriver.driver.getCurrentUrl();
    }
    ...
    public static Alert getAlert() {
        return BaseDriver.driver.switchTo().alert();
    }
    ...
    public static boolean isAlertPresent() {
        try {
            BaseDriver.driver.switchTo().alert();
            return true;
